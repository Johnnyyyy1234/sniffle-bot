...
module.exports = {
  ...
  run: async (client, interaction) => {
    ...
    try {
      ...
      if (!userVoiceChannel || !targetMember.voice || !targetVoiceChannel) {
        return interaction.followUp({
          content: "You and the target member must be in a voice channel!",
          ephemeral: true,
        });
      }
      ...
      await channel.edit({ name: `${targetMember.user.username}'s Channel` });
