...
module.exports = {
	data: new SlashCommandBuilder()
		...
		.addSubcommand((s) =>
			s.setName("remove").setDescription("Remove the Join to create system"),
		)
		.toJSON(),
			...
			case "configure":
				{
					...
					const channelName = options.getString("name") || "Join to create";

					if (dataGD)
						return await interaction.reply({
							content:
								"`❌` This server already has a join-to-create system configured!",
							ephemeral: true,
						});
